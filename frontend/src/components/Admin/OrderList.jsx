          ...
          return (
            <Fragment>
              <Link to={`/admin/order/${params.getValue(params.id, "id")}`}>
                {/* You can use Chakra UI icons here */}
                {/* Replace EditIcon and DeleteIcon with Chakra UI icons */}
              </Link>
              ...
              >
                {/* You can use Chakra UI Button */}
                {/* Replace the DeleteIcon with a Chakra UI icon */}
              </Button>
            </Fragment>
          );
        },
